...
Simply
[import your Ctrl Wallet seed phrase](https://docs.thorswap.finance/thorswap/thorswap/wallets/migrate-ctrl-wallet)
into Metro Wallet and you're ready to go.

If **yes**: you should use V2 THORSwap with Keystore File for accessing these
features, as V3 THORSwap nor Metro Exchange support these features.  Don't
worry &mdash; keep reading for more information.
...
path syntaxes.  Use the default, named `MetaMask (m/44'/xx'/0'/0/{index})`.
